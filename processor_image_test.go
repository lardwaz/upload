...
func (s *ProcessorTestSuite) SetupSuite() {
	...
	s.imageProcessTests = []imageProcessTest{
		...
		{"Watermark Top Left", false, "normal.jpg", "watermarked_tl_normal_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("water"), option.FormatWidth(400), option.FormatHeight(400), option.FormatWatermark(watermarkOptPath, option.WatermarkHorizontal(upload.Left), option.WatermarkVertical(upload.Top))))},
		{"Watermark Top Center", false, "normal.jpg", "watermarked_tc_normal_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("water"), option.FormatWidth(400), option.FormatHeight(400), option.FormatWatermark(watermarkOptPath, option.WatermarkHorizontal(upload.Center), option.WatermarkVertical(upload.Top))))},
		{"Watermark Top Right", false, "normal.jpg", "watermarked_tr_normal_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("water"), option.FormatWidth(400), option.FormatHeight(400), option.FormatWatermark(watermarkOptPath, option.WatermarkHorizontal(upload.Right), option.WatermarkVertical(upload.Top))))},
		{"Watermark Bottom Left", false, "normal.jpg", "watermarked_bl_normal_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("water"), option.FormatWidth(400), option.FormatHeight(400), option.FormatWatermark(watermarkOptPath, option.WatermarkHorizontal(upload.Left), option.WatermarkVertical(upload.Bottom))))},
		{"Watermark Bottom Center", false, "normal.jpg", "watermarked_bc_normal_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("water"), option.FormatWidth(400), option.FormatHeight(400), option.FormatWatermark(watermarkOptPath, option.WatermarkHorizontal(upload.Center), option.WatermarkVertical(upload.Bottom))))},
		{"Watermark Bottom Right", false, "normal.jpg", "watermarked_br_normal_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("water"), option.FormatWidth(400), option.FormatHeight(400), option.FormatWatermark(watermarkOptPath, option.WatermarkHorizontal(upload.Right), option.WatermarkVertical(upload.Bottom))))},
		{"Watermark Center Left", false, "normal.jpg", "watermarked_cl_normal_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("water"), option.FormatWidth(400), option.FormatHeight(400), option.FormatWatermark(watermarkOptPath, option.WatermarkHorizontal(upload.Left), option.WatermarkVertical(upload.Center))))},
		{"Watermark Center Center", false, "normal.jpg", "watermarked_cc_normal_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("water"), option.FormatWidth(400), option.FormatHeight(400), option.FormatWatermark(watermarkOptPath, option.WatermarkHorizontal(upload.Center), option.WatermarkVertical(upload.Center))))},
		{"Watermark Center Right", false, "normal.jpg", "watermarked_cr_normal_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("water"), option.FormatWidth(400), option.FormatHeight(400), option.FormatWatermark(watermarkOptPath, option.WatermarkHorizontal(upload.Right), option.WatermarkVertical(upload.Center))))},
		{"Watermark Bad Pos", false, "normal.jpg", "watermarked_bad_prod_normal_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("water"), option.FormatWidth(400), option.FormatHeight(400), option.FormatWatermark(watermarkOptPath, option.WatermarkHorizontal(10), option.WatermarkVertical(10))))},
		{"PROD Watermark Bad Pos", true, "normal.jpg", "watermarked_bad_normal_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("water"), option.FormatWidth(400), option.FormatHeight(400), option.FormatWatermark(watermarkOptPath, option.WatermarkHorizontal(10), option.WatermarkVertical(10))))},
		{"Watermark Bad Pos", false, "normal.jpg", "watermarked_normal_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("damaged"), option.FormatWidth(400), option.FormatHeight(400), option.FormatWatermark(watermarkOptPath, option.WatermarkHorizontal(upload.Center), option.WatermarkVertical(upload.Center))))},
		{"Backdrop Landscape", false, "normal.jpg", "backdropped_normal_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("back"), option.FormatWidth(200), option.FormatHeight(200), option.FormatBackdrop(backdropOptPath)))},
		{"PROD Backdrop Landscape", true, "normal.jpg", "backdropped_prod_normal_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("back"), option.FormatWidth(200), option.FormatHeight(200), option.FormatBackdrop(backdropOptPath)))},
		{"Backdrop Portrait", false, "portrait.jpg", "backdropped_portrait_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("back"), option.FormatWidth(200), option.FormatHeight(200), option.FormatBackdrop(backdropOptPath)))},
		{"PROD Backdrop Portrait", true, "portrait.jpg", "backdropped_prod_portrait_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("back"), option.FormatWidth(200), option.FormatHeight(200), option.FormatBackdrop(backdropOptPath)))},
		{"Backdrop Damaged", false, "portrait.jpg", "backdropped_portrait_out.jpg", false, upload.NewImageProcessor(option.Formats(option.FormatName("damaged"), option.FormatWidth(200), option.FormatHeight(200), option.FormatBackdrop(backdropOptPath)))},
	}
}
