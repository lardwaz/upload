...
func (s *ProcessorTestSuite) SetupSuite() {
	...
	s.imageProcessTests = []imageProcessTest{
		{"Normal No Format", false, "normal.jpg", "processed_normal_out.jpg", false, NewImageProcessor()},
		{"Normal No Format PNG", false, "normal.png", "processed_normal_out.png", false, NewImageProcessor()},
		{"Normal Format", false, "normal.jpg", "processed_normal_out.jpg", false, NewImageProcessor(Format("thumb", 200, 200, false))},
		{"PROD Normal Format", true, "normal.jpg", "processed_prod_normal_out.jpg", false, NewImageProcessor(Format("thumb", 200, 200, false))},
		{"Normal Format PNG", false, "normal.png", "processed_normal_out.png", false, NewImageProcessor(Format("thumb", 200, 200, false))},
		{"PROD Normal Format PNG", true, "normal.png", "processed_prod_normal_out.png", false, NewImageProcessor(Format("thumb", 200, 200, false))},
		{"Normal Height Zero", false, "normal.jpg", "processed_normal_out.jpg", false, NewImageProcessor(Format("hzero", 200, 0, false))},
		{"Normal Width Zero", false, "normal.jpg", "processed_normal_out.jpg", false, NewImageProcessor(Format("wzero", 0, 200, false))},
		{"Normal Upscale", false, "normal.jpg", "processed_normal_out.jpg", false, NewImageProcessor(Format("upscale", 500, 500, false))},
		{"Small Width", false, "normal.jpg", "processed_normal_out.jpg", true, NewImageProcessor(MinWidth(500))},
		{"Small Height", false, "normal.jpg", "processed_normal_out.jpg", true, NewImageProcessor(MinHeight(500))},
		{"Invalid File Type", false, "damaged.jpg", "processed_normal_out.jpg", true, NewImageProcessor()},
		{"Invalid Image Type", false, "normal.gif", "processed_normal_out.gif", true, NewImageProcessor()},
